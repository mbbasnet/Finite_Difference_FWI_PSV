...
snap_z1 = 50; snap_z2 = nz-51; snap_x1 = 25; snap_x2 = nx-51 # snap boundaries
...
xsrc = np.full((zsrc.size,), 30, dtype=np.int32)
...
zrec = np.linspace(30, 571, 72, dtype=np.int32)
xrec = np.full((zrec.size,), 370, dtype=np.int32)
nrec = zrec.size
